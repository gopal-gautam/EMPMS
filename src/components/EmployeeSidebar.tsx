...
const EmployeeSidebar: React.FC<EmployeeSidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  return (
    <div
      ...
      } bg-gradient-to-b from-blue-600 to-purple-600 text-white transition-all duration-300 ease-in-out flex flex-col shadow-2xl`}
    >
      {/* Header */}
